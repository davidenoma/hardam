...
from software_deps.MetaXcan.metax import PrediXcanFormatUtilities, ThousandGenomesUtilities
from software_deps.MetaXcan.metax import Formats, WeightDBUtilities, Logging, Utilities
