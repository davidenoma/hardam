...
from software_deps.MetaXcan.metax import __version__
from software_deps.MetaXcan.metax import Exceptions, Logging, Utilities

from software_deps.MetaXcan.metax.predixcan import MultiPrediXcanAssociation, Utilities as MultiPrediXcanUtilities
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", help="Type of regression. Can be: {}".format(
        MultiPrediXcanAssociation.MTPMode.K_MODES), default=MultiPrediXcanAssociation.MTPMode.K_LINEAR)
