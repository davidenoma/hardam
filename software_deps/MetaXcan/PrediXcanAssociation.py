...
from software_deps.MetaXcan.metax.predixcan import PrediXcanAssociation as PA, Utilities as PrediXcanUtilities
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='PrediXcanAssociation.py %s: Single-Tissue PrediXcan association' % (
        metax.__version__))
